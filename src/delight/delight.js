...
var availableNodes = {
    ...
    "Number": [
        ...
        _nodes_library_number_random__WEBPACK_IMPORTED_MODULE_9__["RandomNumberNode"],
        null,
...
var NumberValueNode = /** @class */ (function (_super) {
    ...
    function NumberValueNode() {
        ...
        _this.outputs = [
            new _socket__WEBPACK_IMPORTED_MODULE_1__["Socket"](_this, "number", "Number", _socket__WEBPACK_IMPORTED_MODULE_1__["SocketType"].output, new _types_number__WEBPACK_IMPORTED_MODULE_2__["NumberType"](), true, false)
        ];
        return _this;
    }
...
/***/ "./src/delight/nodes/library/number/random.ts":
/*!****************************************************!*\
  !*** ./src/delight/nodes/library/number/random.ts ***!
  \****************************************************/
/*! exports provided: RandomNumberNode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RandomNumberNode", function() { return RandomNumberNode; });
/* harmony import */ var _node__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../node */ "./src/delight/nodes/node.ts");
/* harmony import */ var _socket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../socket */ "./src/delight/nodes/socket.ts");
/* harmony import */ var _types_number__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../types/number */ "./src/delight/nodes/types/number.ts");
var __extends = (undefined && undefined.__extends) || (function () {
...
var RandomNumberNode = /** @class */ (function (_super) {
    ...
    function RandomNumberNode() {
        ...
        _this.category = _node__WEBPACK_IMPORTED_MODULE_0__["NodeCategory"].number;
        _this.outputs = [
            new _socket__WEBPACK_IMPORTED_MODULE_1__["Socket"](_this, "number", "Number", _socket__WEBPACK_IMPORTED_MODULE_1__["SocketType"].output, new _types_number__WEBPACK_IMPORTED_MODULE_2__["NumberType"](), false)
        ];
        return _this;
    }
    RandomNumberNode.prototype.process = function () {
        return __awaiter(this, void 0, void 0, function () {
            var out;
            return __generator(this, function (_a) {
                out = this.getOutput("number");
                out.value = Math.random();
                return [2 /*return*/];
            });
        });
    };
    RandomNumberNode.id = "number.random";
    RandomNumberNode.listName = "Random";
